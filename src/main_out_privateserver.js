...
(function() {
    ...
    if (typeof WebSocket === 'undefined' || typeof DataView === 'undefined' ||
        ...
        alert('Your browser does not support the required features, please update your browser or get a new one.');
        window.stop();
    }
...
// ctx.fillTextFormatted(`hi, hello, world!`, x, y += 40);
    ...
    var wsUrl = null,
        ...
        EMPTY_NAME = "An unnamed BioBit  q",
    ...
    function wsMessage(data) {
        ...
        switch (packetId) {
            ...
            case 0x63: // chat message
                ...
                if (admin) name = "§4ᴬᴰᴹᴺై ⃟§bꦿꦼ" + name;
    ...
    function drawBackgroundSectors() {
        ...
        mainCtx.font = (w / 3 | 0) + "px Odibee Sans";
    ...
    function drawMinimap() {
        ...
        mainCtx.textBaseline = "middle";
        mainCtx.textAlign = "center";
        mainCtx.font = sectorNameSize + "px Odibee Sans";
        ...
        if (cell !== null) {
            ...
            mainCtx.font = textSize + "px Odibee Sans";
    ...
    function drawGame() {
        ...
        if (!isNaN(stats.score)) {
            mainCtx.font = "30px Odibee Sans";
            mainCtx.fillText("Score: " + stats.score, 2, height);
            height += 30;
        }
        mainCtx.font = "20px Odibee Sans";
